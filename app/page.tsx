  ...
  return <div className="min-h-screen bg-[radial-gradient(circle_at_50%_-20%,#134e4a_0%,#070b14_45%)]"><Navbar />
    <main>
      <section className="mx-auto max-w-7xl px-5 py-24 text-center sm:py-32 lg:px-8">
        ...
        <div className="mt-9 flex flex-wrap justify-center gap-3"><Link href="/signup" className="button-primary">Create workspace</Link><Link href="/dashboard" className="button-secondary">Explore the skeleton <span className="ml-2">→</span></Link></div>
      ...
      <section className="mx-auto max-w-3xl px-5 py-24 text-center"><h2 className="text-3xl font-bold text-white">Make the next release decision defensible.</h2><p className="mt-4 text-slate-400">Set up your evaluation workspace or preview the Phase 2 command center.</p><div className="mt-7 flex justify-center gap-3"><Link href="/login" className="button-secondary">Log in</Link><Link href="/signup" className="button-primary">Get started</Link></div></section>
